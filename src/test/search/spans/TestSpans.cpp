...
const wchar_t * TestSpans::field = _T( "field" );
const wchar_t * TestSpans::docFields[] =
{
    _T( "w1 w2 w3 w4 w5" ),
    _T( "w1 w3 w2 w3" ),
    _T( "w1 xx w2 yy w3" ),
...
SpanTermQuery * TestSpans::makeSpanTermQuery( const wchar_t * text )
{
...
void TestSpans::orSpans( const wchar_t ** terms, size_t termsCount, Spans *& spans, Query *& query )
{
...
void TestSpans::testSpanOrDouble()
{
    Spans * spans;
    Query * query;
    const wchar_t* terms[] = { _T( "w5" ), _T( "yy" ) };
...
void TestSpans::testSpanOrUnused()
{
    Spans * spans;
    Query * query;
    const wchar_t* terms[] = { _T( "w5" ), _T( "unusedTerm" ), _T( "yy" ) };
...
void TestSpans::testSpanOrTripleSameDoc()
{
    Spans * spans;
    Query * query;
    const wchar_t* terms[] = { _T( "t1" ), _T( "t2" ), _T( "t3" ) };
    orSpans( terms, 3, spans, query );
