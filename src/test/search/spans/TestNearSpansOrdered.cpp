...
const wchar_t * TestNearSpansOrdered::field = _T( "field" );
const wchar_t * TestNearSpansOrdered::docFields[] =
{
    _T( "w1 w2 w3 w4 w5" ),
    _T( "w1 w3 w2 w3 zz" ),
    _T( "w1 xx w2 yy w3" ),
...
SpanNearQuery * TestNearSpansOrdered::makeQuery( const wchar_t * s1, const wchar_t * s2, const wchar_t * s3, int32_t slop, bool inOrder )
{
