...
public:
     ...
     */
    static void checkNoMatchExplanations( CuTest* tc, Query * q, const wchar_t * defaultFieldName, Searcher * searcher, int32_t * results, size_t resultsCount );
     ...
     * @see #checkHits
     */
    static void checkHitCollector( CuTest* tc, Query * query, const wchar_t * defaultFieldName, Searcher * searcher, int32_t * results, size_t resultsCount );
     ...
     */
    static void checkHits( CuTest* tc, Query * query, const wchar_t * defaultFieldName, Searcher * searcher, int32_t * results, size_t resultsCount );

    /** Tests that a Hits has an expected order of documents */
    static void checkDocIds( CuTest* tc, const wchar_t * mes, int32_t * results, size_t resultsCount, Hits * hits );
     ...
     * @param defaultFieldName used for displaing the query in assertion messages
     */
    static void checkExplanations( CuTest* tc, Query * query, const wchar_t * defaultFieldName, Searcher * searcher );
     ...
     */
    static void checkExplanations( CuTest* tc, Query * query, const wchar_t * defaultFieldName, Searcher * searcher, bool deep );
     ...
     */
    static void verifyExplanation( CuTest* tc, const wchar_t * q, int32_t doc, float_t score, bool deep, Explanation * expl );

    static bool setEquals( set<int32_t>& s1, set<int32_t>& s2 );
    static bool stringEndsWith( const wchar_t* tszStr, const wchar_t * tszEnd );
