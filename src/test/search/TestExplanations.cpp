...
/////////////////////////////////////////////////////////////////////////////
const wchar_t * TestExplanations::field = _T( "field" );
const wchar_t * TestExplanations::docFields[] =
{
    _T( "w1 w2 w3 w4 w5" ),
    _T( "w1 w3 w2 w3 zz" ),
    _T( "w1 xx w2 yy w3" ),
...
Query * TestExplanations::makeQuery( const wchar_t * queryText )
{
    return qp->parse( queryText );
}

void TestExplanations::qtest( const wchar_t * queryText, int32_t * expDocNrs, size_t expDocNrsCount )
{
...
void TestExplanations::bqtest( const wchar_t * queryText, int32_t * expDocNrs, size_t expDocNrsCount )
{
    Query * q = makeQuery( queryText );
...
Term ** TestExplanations::ta( const wchar_t ** s, size_t count )
{
...
SpanTermQuery * TestExplanations::st( const wchar_t * s )
{
...
SpanOrQuery * TestExplanations::sor( const wchar_t * s,  const wchar_t * e ) 
{
...
SpanOrQuery * TestExplanations::sor( const wchar_t * s,  const wchar_t * m,  const wchar_t * e) 
{
...
SpanNearQuery * TestExplanations::snear( const wchar_t * s,  const wchar_t * e, int32_t slop, bool inOrder )
{
...
SpanNearQuery * TestExplanations::snear( const wchar_t * s,  const wchar_t * m,  const wchar_t * e, int32_t slop, bool inOrder ) 
{
...
SpanFirstQuery * TestExplanations::sf( const wchar_t * s, int32_t b )
{
    return _CLNEW SpanFirstQuery( st( s ), b, true );
}

Query * TestExplanations::optB( const wchar_t * q )
{
...
Query * TestExplanations::reqB( const wchar_t * q )
{
