...
public:
    ...
    /////////////////////////////////////////////////////////////////////////////
    Query * csrq(const wchar_t* f, const wchar_t* l, const wchar_t* h, bool il, bool ih) 
    {
    ...
    void testRangeQueryId()
    {
        ...
        const wchar_t* minIP = sMinIP.c_str();
        const wchar_t* maxIP = sMaxIP.c_str();
        const wchar_t* medIP = sMedIP.c_str();
    ...
    void testRangeQueryRand()
    {
        ...
        const wchar_t* minRP = sMinRP.c_str();
        const wchar_t* maxRP = sMaxRP.c_str();
