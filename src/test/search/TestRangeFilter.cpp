...
public:
    ...
    void testRangeFilterId() {
        ...
        const wchar_t* minIP = minIPstr.c_str();

        std::tstring maxIPstr = pad(maxId);
        const wchar_t* maxIP = maxIPstr.c_str();

        std::tstring medIPstr = pad(medId);
        const wchar_t* medIP = medIPstr.c_str();
    ...
    void testRangeFilterRand()
    {
        ...
        const wchar_t* minRP = minRPstr.c_str();
        
        std::tstring maxRPstr = pad(maxR);
        const wchar_t* maxRP = maxRPstr.c_str();
