...
void __cdecl searchDocs (void * _searcher)
{
    ...
    Misc::Sleep(0); //make sure that searchMutex is being waited on...
...
void testEndThreadException(CuTest *tc) {
    ...
    // this sequence is OK: delete searcher after search thread finish
    {
        ...
        Misc::Sleep(0); //make sure that deleteMutex is being waited on...
