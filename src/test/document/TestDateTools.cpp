...
void assertDateTimeEquals(CuTest* tc, const wchar_t* isoFormat, int64_t d){
    wchar_t* tmp = DateTools::getISOFormat(d);
    int res = wcscmp(isoFormat, tmp);
...
void testDateAndTimetoString(CuTest* tc) {
    ...
    CLUCENE_ASSERT( wcscmp(_T("2004"), dateString) == 0 );
    ...
    CLUCENE_ASSERT( wcscmp(_T("200402"), dateString) == 0 );
    ...
    CLUCENE_ASSERT( wcscmp(_T("20040203"), dateString) == 0 );
    ...
    CLUCENE_ASSERT( wcscmp(_T("2004020322"), dateString) == 0 );
    ...
    CLUCENE_ASSERT( wcscmp(_T("200402032208"), dateString) == 0 );
    ...
    CLUCENE_ASSERT( wcscmp(_T("20040203220856"), dateString) == 0 );
    ...
    CLUCENE_ASSERT( wcscmp(_T("20040203220856333"), dateString) == 0 );
