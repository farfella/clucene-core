...
------------------------------------------------------------------------------*/
#ifndef _REPL_wchar_t_H
#define _REPL_wchar_t_H
        ...
        #define _snwprintf swprintf //* make a formatted a string
        ...
        #define wcscpy wcscpy //copy a string to another string
        #define wcsncpy wcsncpy //copy a specified amount of one string to another string.
        ...
        #define wcsstr wcsstr //find location of a string
        #define wcslen wcslen //get length of a string
        #define wcscmp wcscmp //case sensitive compare two strings
...
#define STRDUP_AtoA(x) _strdup(x)
  ...
  //#define wcscpy STRCPY_AtoA
#endif


#endif //_REPL_wchar_t_H
