...
CLUCENE_SHARED_EXPORT int cl_tcscasefoldcmp(const wchar_t * dst, const wchar_t * src);
CLUCENE_SHARED_EXPORT wchar_t* cl_tcscasefold( wchar_t * str, int len=-1 );
...
//string function replacements
    ...
    CLUCENE_SHARED_EXPORT int lucene_tcscasecmp(const wchar_t *, const wchar_t *);
    #undef _tcsicmp
    ...
    CLUCENE_SHARED_EXPORT wchar_t* lucene_tcslwr( wchar_t* str );
    #undef _tcslwr
...
//conversion functions
	...
	CLUCENE_SHARED_EXPORT int64_t lucene_tcstoi64(const wchar_t* str, wchar_t**end, int radix);
    #undef _tcstoi64
    #define _tcstoi64 lucene_tcstoi64
#endif
#if defined(_UCS2) && !defined(_CL_HAVE_FUNCTION_WCSTOD)
    CLUCENE_SHARED_EXPORT double lucene_tcstod(const wchar_t *value, wchar_t **end);
    #undef _tcstod
...
//printf functions
    ...
    //#undef _snwprintf
    //#define _snwprintf lucene_snwprintf
