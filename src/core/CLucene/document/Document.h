...
public:
	...
	*/
	void removeField(const wchar_t* name);
	...
	* Note: name is case sensitive
	*/
	void removeFields(const wchar_t* name);
	...
	*/
	Field* getField(const wchar_t* name) const;
	...
	* Note: name is case sensitive
	*/
	const wchar_t* get(const wchar_t* field) const;
  ...
  */
   ...
   */
  void getFields(const wchar_t* name, std::vector<Field*>& ret);
	...
	*
	* @param name the name of the field
	* @return a <code>wchar_t**</code> of field values or <code>null</code>
	*/
	wchar_t** getValues(const wchar_t* name);
