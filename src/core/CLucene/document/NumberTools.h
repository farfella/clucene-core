...
class CLUCENE_EXPORT NumberTools :LUCENE_BASE {
	...
	#define NEGATIVE_PREFIX L"-"
	// NB: NEGATIVE_PREFIX must be < POSITIVE_PREFIX
	#define POSITIVE_PREFIX L"0"
...
public:
     ...
     */
	static const wchar_t* MIN_STRING_VALUE;

	/**
     * Equivalent to longToString(Long.MAX_VALUE)
     */
	static const wchar_t* MAX_STRING_VALUE;
     ...
     */
    static wchar_t* longToString(int64_t l);
     ...
     *             longToString()).
     */
    static int64_t stringToLong(const wchar_t* str);
