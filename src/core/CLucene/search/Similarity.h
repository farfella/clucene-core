...
*    {@link #lengthNorm(wchar_t*,int32_t) lengthNorm}(t.field in d)
*    </small></td>
...
public:
   ...
   * @see Field#setBoost(float_t)
   */
   virtual float_t lengthNorm(const wchar_t* fieldName, int32_t numTokens) = 0;
...
public:
  ...
  float_t lengthNorm(const wchar_t* fieldName, int32_t numTerms);
