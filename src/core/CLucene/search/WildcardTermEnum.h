...
CL_NS_DEF(search)
    ...
    private:
        ...
        /********************************************
        * const wchar_t* equality with support for wildcards
        ********************************************/
		...
		*/
         ...
         */
        static bool wildcardEquals(const wchar_t* pattern, int32_t patternLen, int32_t patternIdx, const wchar_t* str, int32_t strLen, int32_t stringIdx);
