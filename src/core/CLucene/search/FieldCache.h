...
public:
   virtual ~FieldCache(){
	...
	public:
        ...
        */
		StringIndex (int32_t* values, wchar_t** lookup, int count);
        ~StringIndex();
	};
  ...
  */
   ...
   */
  virtual FieldCacheAuto* getInts (CL_NS(index)::IndexReader* reader, const wchar_t* field) = 0;
   ...
   * @throws IOException  If any error occurs.
   */
  virtual FieldCacheAuto* getFloats (CL_NS(index)::IndexReader* reader, const wchar_t* field) = 0;
   ...
   * @throws IOException  If any error occurs.
   */
  virtual FieldCacheAuto* getStrings (CL_NS(index)::IndexReader* reader, const wchar_t* field) = 0;
   ...
   * @throws IOException  If any error occurs.
   */
   virtual FieldCacheAuto* getStringIndex (CL_NS(index)::IndexReader* reader, const wchar_t* field) = 0;
   ...
   * @throws IOException  If any error occurs.
   */
   virtual FieldCacheAuto* getAuto (CL_NS(index)::IndexReader* reader, const wchar_t* field) = 0;
   ...
   * @throws IOException  If any error occurs.
   */
   virtual FieldCacheAuto* getCustom (CL_NS(index)::IndexReader* reader, const wchar_t* field, SortComparator* comparator) = 0;
