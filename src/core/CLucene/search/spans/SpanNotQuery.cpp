...
std::wstring SpanNotQuery::SpanNotQuerySpans::toString() const
{
    std::wstring buffer;
...
SpanNotQuery::SpanNotQuery(SpanQuery * include, SpanQuery * exclude, bool bDeleteQueries)
{
    ...
    if (0 != wcscmp(include->getField(), exclude->getField()))
...
const std::wstring SpanNotQuery::getClassName()
{
    return L"SpanNotQuery";
}

const std::wstring SpanNotQuery::getObjectName() const
{
    return getClassName();
}
...
const wchar_t * SpanNotQuery::getField() const
{
...
std::wstring SpanNotQuery::toString(const wchar_t* field) const
{
    std::wstring buffer;
