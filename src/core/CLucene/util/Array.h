...
/**
* An array of wchar_t strings
*/
class CLUCENE_INLINE_EXPORT wchar_tArray: public ArrayBase<wchar_t*>{
public:
  wchar_tArray():ArrayBase<wchar_t*>(){}
	wchar_tArray(size_t length):ArrayBase<wchar_t*>(length){}
  ...
  void deleteValue(wchar_t* v){
		  _CLDELETE_LCARRAY(v);
  }
	virtual ~wchar_tArray(){
	    deleteValues();
	}
};
...
/**
* An array of const wchar_t strings
*/
class CLUCENE_INLINE_EXPORT wchar_tConstArray: public ArrayBase<const wchar_t*>{
public:
  wchar_tConstArray():ArrayBase<const wchar_t*>(){}
	wchar_tConstArray(size_t length):ArrayBase<const wchar_t*>(length){}
