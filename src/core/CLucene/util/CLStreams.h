...
class CLUCENE_EXPORT Reader: public CLStream<wchar_t>{
public:
	~Reader(){}
	virtual BufferedReader* __asBufferedReader(){ return NULL; }
};
class CLUCENE_EXPORT BufferedReader: public Reader, public BufferedStream<wchar_t>{
public:
...
protected:
  ...
  size_t buffer_size;
public:
  StringReader ( const wchar_t* value, const int32_t length = -1, bool copyData = true );
  void init ( const wchar_t* value, const int32_t length, bool copyData = true );
