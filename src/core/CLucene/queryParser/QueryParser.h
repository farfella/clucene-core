...
public:
    ...
    */
    QueryParser(const wchar_t* f, CL_NS(analysis)::Analyzer* a);
    virtual ~QueryParser();
    void _deleteTokens();

    /** For backward compatibility */
    static CL_NS(search)::Query* parse(const wchar_t* q, const wchar_t* f, CL_NS(analysis)::Analyzer* a);

    /** Parses a query string, returning a {@link org.apache.lucene.search.Query}.
    *  @param query  the query string to be parsed.
    *  @throws ParseException if the parsing fails
    */
    CL_NS(search)::Query* parse(const wchar_t* _query);
    ...
    */
    void setDateResolution(const wchar_t* fieldName, const CL_NS(document)::DateTools::Resolution _dateResolution);
    ...
    *
    */
    CL_NS(document)::DateTools::Resolution getDateResolution(const wchar_t* fieldName) const;
...
protected:
    ...
    */
    virtual CL_NS(search)::Query* getFieldQuery(const wchar_t* _field, wchar_t* queryText);
    ...
    * @exception ParseException throw in overridden method to disallow
    */
    virtual CL_NS(search)::Query* getFieldQuery(const wchar_t* _field, wchar_t* queryText, const int32_t slop);

    /**
    * @exception ParseException throw in overridden method to disallow
    */
    virtual CL_NS(search)::Query* getRangeQuery(const wchar_t* field, wchar_t* part1, wchar_t* part2, const bool inclusive);
    ...
    * @exception ParseException throw in overridden method to disallow
    */
    virtual CL_NS(search)::Query* getWildcardQuery(const wchar_t* _field, wchar_t* termStr);
    ...
    * @exception ParseException throw in overridden method to disallow
    */
    virtual CL_NS(search)::Query* getPrefixQuery(const wchar_t* _field, wchar_t* _termStr);
    ...
    * @exception ParseException throw in overridden method to disallow
    */
    virtual CL_NS(search)::Query* getFuzzyQuery(const wchar_t* _field, wchar_t* termStr, const float_t minSimilarity);
...
private:
    ...
    *
    */
    wchar_t* discardEscapeChar(wchar_t* input, wchar_t* output = NULL);
...
public:
    ...
    */
    ...
    CL_NS(search)::Query* TopLevelQuery(wchar_t* _field);

    CL_NS(search)::Query* fQuery(wchar_t* _field);

    CL_NS(search)::Query* fClause(wchar_t* _field);

public:
    CL_NS(search)::Query* fTerm(const wchar_t* _field);
...
private:
    ...
    std::wstring getParseExceptionMessage(QueryToken* currentToken,
        CL_NS(util)::CLVector<  CL_NS(util)::ValueArray<int32_t>*,
