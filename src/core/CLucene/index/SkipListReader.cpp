...
const std::wstring MultiLevelSkipListReader::SkipBuffer::getObjectName() const { return getClassName(); }
const std::wstring MultiLevelSkipListReader::SkipBuffer::getClassName() { return L"MultiLevelSkipListReader::SkipBuffer"; }

const std::wstring MultiLevelSkipListReader::SkipBuffer::getDirectoryType() const { return L"SKIP"; }
