...
protected:
  ...
  */
  ...
  virtual void doSetNorm(int32_t doc, const wchar_t* field, uint8_t value) = 0;
...
public:
   ...
   */
	...
	*/
	virtual uint8_t* norms(const wchar_t* field) = 0;
	...
	* @see Field#setBoost(float_t)
	*/
	virtual void norms(const wchar_t* field, uint8_t* bytes) = 0;
  ...
  * @throws IOException if there is a low-level IO error
  */
  void setNorm(int32_t doc, const wchar_t* field, float_t value);

  /** Expert: Resets the normalization factor for the named field of the named
  * document.  The norm represents the product of the field's {@link
  * Field#setBoost(float_t) boost} and its {@link Similarity#lengthNorm(wchar_t*,
  ...
  * @throws IOException if there is a low-level IO error
  */
  void setNorm(int32_t doc, const wchar_t* field, uint8_t value);
  ...
  * @see org.apache.lucene.document.Field.TermVector
  */
  virtual TermFreqVector* getTermFreqVector(int32_t docNumber, const wchar_t* field=NULL) = 0;
   ...
   *
   */
  virtual void getTermFreqVector(int32_t docNumber, const wchar_t* field, TermVectorMapper* mapper) =0;
  ...
  */
  bool document(int32_t n, CL_NS(document)::Document& doc);
	...
	virtual bool hasNorms(const wchar_t* field);
