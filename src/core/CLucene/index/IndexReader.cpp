...
CL_NS_DEF(index)
  ...
  void IndexReader::setNorm(int32_t doc, const wchar_t* field, uint8_t value){
    SCOPED_LOCK_MUTEX(THIS_LOCK)
    this->ensureOpen();
  ...
  void IndexReader::setNorm(int32_t doc, const wchar_t* field, float_t value){
     ensureOpen();
...
bool IndexReader::hasNorms(const wchar_t* field) {
