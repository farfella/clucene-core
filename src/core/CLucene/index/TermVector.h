...
public:
	...
	*/
	virtual const CL_NS(util)::ArrayBase<const wchar_t*>* getTerms() = 0;
	...
	*  return -1.
	*/
	virtual int32_t indexOf(const wchar_t* term) = 0;
	...
	*/
	virtual CL_NS(util)::ArrayBase<int32_t>* indexesOf(const CL_NS(util)::ArrayBase<wchar_t*>& terms, const int32_t start, const int32_t len) = 0;
