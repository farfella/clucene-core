...
class TermInfo;
    ...
    bool isIndex;
    CL_NS(util)::ValueArray<wchar_t> lastTermText;
    int32_t lastTermTextLength;
    int32_t lastFieldNumber;

    CL_NS(util)::ValueArray<wchar_t> termTextBuffer;
    ...
    */
    ...
    TermInfo pointers must be positive and greater than all previous.*/
		void add(int32_t fieldNumber, const wchar_t* termText, int32_t termTextLength, const TermInfo* ti);
