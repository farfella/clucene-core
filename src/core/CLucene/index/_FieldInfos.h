...
class FieldInfo :LUCENE_BASE{
  public:
	...
	//       isIndexed = tk
	//       number = nu  
	FieldInfo(const wchar_t* fieldName, 
...
class CLUCENE_EXPORT FieldInfos :LUCENE_BASE{
	...
	typedef CL_NS(util)::CLHashMap<const wchar_t*,FieldInfo*,CL_NS(util)::Compare::WChar,CL_NS(util)::Equals::WChar > defByName;
	defByName byName;
...
public:
	...
	* 
	* @param names The names of the fields. An array of wchar_ts, last item has to be NULL
	* @param storeTermVectors Whether the fields store term vectors or not
	* @param storePositionWithTermVector treu if positions should be stored.
	* @param storeOffsetWithTermVector true if offsets should be stored
	*/
	void addIndexed(const wchar_t** names, const bool storeTermVectors, const bool storePositionWithTermVector, const bool storeOffsetWithTermVector);
	...
	* 
	* @see #add(wchar_t*, bool)
	*/
	void add(const wchar_t** names, const bool isIndexed, const bool storeTermVector=false,
	...
	*/
	FieldInfo* add(const wchar_t* name, const bool isIndexed, const bool storeTermVector=false,
	...
	// was void
	FieldInfo* addInternal( const wchar_t* name,const bool isIndexed, const bool storeTermVector,
	...
	int32_t fieldNumber(const wchar_t* fieldName)const;
	...
	* doesn't exist.
	*/ 
	FieldInfo* fieldInfo(const wchar_t* fieldName) const;
	...
	*/  
	const wchar_t* fieldName(const int32_t fieldNumber)const;
