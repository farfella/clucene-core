...
public:
  ...
  */
	Term(const Term* fieldTerm, const wchar_t* txt);
   ...
   * behavior for most Lucene APIs that accept a Term parameter.
  */
	Term(const wchar_t* fld, const wchar_t* txt, bool internField);
	...
	* behavior for most Lucene APIs that accept a Term parameter.
	*/
	Term(const wchar_t* fld, const wchar_t* txt);
	...
	const wchar_t* field() const; ///<returns reference

	///Returns the text of this term.  In the case of words, this is simply the
	///text of the word.  In the case of dates and other types, this is an
	///encoding of the object as a string.
	const wchar_t* text() const; ///<returns reference
	
	///Resets the field and text of a Term.
	inline void set(const wchar_t* fld, const wchar_t* txt){
		set(fld,txt,true);
	}
	...
	*/
	void set(const Term* term, const wchar_t* txt);

	void set(const wchar_t* fld, const wchar_t* txt, const bool internField);
