...
#define StringArrayWithDeletor       CL_NS(util)::CLVector<wchar_t*, CL_NS(util)::Deletor::tcArray >
#define StringArray                  std::vector<wchar_t*>
#define StringArrayWithDeletor       CL_NS(util)::CLVector<wchar_t*, CL_NS(util)::Deletor::tcArray >
#define StringArrayConst             std::vector<const wchar_t*>
//#define StringArrayConstWithDeletor  CL_NS(util)::CLVector<const wchar_t*, CL_NS(util)::Deletor::tcArray >
