        ...
        */
        ...
        public:
             ...
             * buffering.
                 ...
                 */
                 int32_t readString(wchar_t* buffer, const int32_t maxlength);
                 ...
                 */
                 void readChars(wchar_t* buffer, const int32_t start, const int32_t len);
                 ...
                 */
                 ...
                 virtual const std::wstring getDirectoryType() const = 0;
                 virtual const std::wstring getObjectName() const = 0;
        };
